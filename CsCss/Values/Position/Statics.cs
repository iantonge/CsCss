...
namespace CsCss
{
    ...
    {
        public static readonly CenterPositionValue Center = CenterPositionValue.Center;
        public static readonly HorizontalPositionValue Left = HorizontalPositionValue.Left;
