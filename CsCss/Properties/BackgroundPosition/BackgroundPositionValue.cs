...
public class BackgroundPositionValue : Value
{
    ...
    {
        return new($"{value.h} {value.hl} {value.v}");
    }
    ...
    {
        return new($"{value.v} {value.vl} {value.h}");
    }
    ...
    {
        return new($"{value.h} {value.hl} {value.c}");
    }
    ...
    {
        return new($"{value.v} {value.vl} {value.c}");
    }
    ...
    {
        return new($"{value.c} {value.cl} {value.v}");
    }
    ...
    {
        return new($"{value.c} {value.cl} {value.h}");
    }
    ...
    {
        return new($"{value.c1} {value.c1l} {value.c2}");
    }
    ...
    {
        return new($"{value.h} {value.v} {value.vl}");
    }
    ...
    {
        return new($"{value.v} {value.h} {value.hl}");
    }
    ...
    {
        return new($"{value.h} {value.c} {value.cl}");
    }
    ...
    {
        return new($"{value.v} {value.c} {value.cl}");
    }
    ...
    {
        return new($"{value.c} {value.h} {value.hl}");
    }
    ...
    {
        return new($"{value.c} {value.v} {value.vl}");
    }
    ...
    {
        return new($"{value.c2} {value.c2} {value.c2l}");
    }
    ...
    {
        return new($"{value.h} {value.hl} {value.v} {value.vl}");
    }
    ...
    {
        return new($"{value.v} {value.vl} {value.h} {value.hl}");
    }
    ...
    {
        return new($"{value.c} {value.cl} {value.v} {value.vl}");
    }
    ...
    {
        return new($"{value.c} {value.cl} {value.h} {value.hl}");
    }
    ...
    {
        return new($"{value.h} {value.hl} {value.c} {value.cl}");
    }
    ...
    {
        return new($"{value.v} {value.vl} {value.c} {value.cl}");
    }
    ...
    {
        return new($"{value.c1} {value.c1l} {value.c2} {value.c2l}");
    }
}
