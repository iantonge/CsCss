...
namespace CsCss.Tests.Values.Numeric.TimePercentage
{
    public class TimePercentageValueTests
    {
        ...
        {
            var lengthPercentage1 = Statics.Calc(5.Percent() + 5.S());
            var lengthPercentage2 = Statics.Calc(10.Percent() + 10.S());
        ...
        {
            var lengthPercentage = Statics.Calc(5.Percent() + 5.S());
